...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
	...
	<style>
		.add-new-menufacturer a {
			color: #ffffff !important;
		}
		.add-new-menufacturer a:focus, .add-new-menufacturer a:hover {
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="{{url('/admin/dashboard/neworder')}}">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/dashboard/neworder')}}"
                                aria-expanded="false">
                          ...
                          <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/dashboard/rejected-list')}}"
                                aria-expanded="false">
                                <i class="fa fa-ban" aria-hidden="true"></i>
                                <span class="hide-menu">Rejected Orders</span>
                            </a>
                        </li>
                        
                        <!--<li class="sidebar-item">-->
                        <!--    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/dashboard/menu-qc')}}"-->
                        <!--        aria-expanded="false">-->
                        <!--        <i class="fa fa-table" aria-hidden="true"></i>-->
                        <!--        <span class="hide-menu">Menu QC</span>-->
                        <!--    </a>-->
                        <!--</li>-->
                        
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/dashboard/order-links')}}"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                                <span class="hide-menu">Order Links</span>
                            </a>
                        </li>
                        
                        
                         <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/dashboard/completed-order')}}"
                                aria-expanded="false">
                           ...
                           <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/admin/dashboard/users')}}"
                                aria-expanded="false">
                                <i class="fa fa-tasks" aria-hidden="true"></i>
                                <span class="hide-menu">Manufacturer</span>
                            </a>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center"> 2021 © Vaxiband Admin<a
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
	...
	<script> 
        $(document).ready(() => {
			...
			$("#icon-datepicker").on("click",() => {
				$('#icon-datepicker').datepicker('show');
			});
			...
			const current_value = $('select[name="vaccine"]').find(":selected").text();
        ...
        var array = [];
        $("input:checkbox[name=bulk]:checked").each(function() {
        array.push($(this).val());
        });
        console.log(Object.values(array));
            ...
            url: '{{url('/admin/dashboard/ApproveAll')}}',
            datatType : 'json',
            type: 'get',
            data: {
                status: array
