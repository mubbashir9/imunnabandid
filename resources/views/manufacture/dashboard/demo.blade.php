            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="dashboard.html">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="../public/admin/plugins/images/logo-icon.png" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="../public/admin/plugins/images/logo-text.png" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
...
logout
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!--                    <div class="user-img"> <img src="../public/admin/plugins/images/users/pawandeep.jpg" alt="user"-->
                <!--                            class="img-circle">-->
                <!--                    </div>-->
                ...
                <!--                </div>-->
                <!--                <div class="comment-body d-flex">-->
                <!--                    <div class="user-img"> <img src="../public/admin/plugins/images/users/sonu.jpg" alt="user"-->
                <!--                            class="img-circle">-->
                <!--                    </div>-->
                <!--                    <div class="mail-contnet">-->
                ...
                <!--                    <div class="user-img"> <img src="../public/admin/plugins/images/users/arijit.jpg" alt="user"-->
                <!--                            class="img-circle">-->
                <!--                    </div>-->
                <!--                    <div class="mail-contnet">-->
                ...
                <!--                                src="../public/admin/plugins/images/users/varun.jpg" alt="user-img" class="img-circle">-->
                <!--                            <div class="ml-2">-->
                ...
                <!--                        </div>-->
                <!--                        <a href="javascript:void(0)" class="d-flex align-items-center"><img-->
                <!--                                src="../public/admin/plugins/images/users/genu.jpg" alt="user-img" class="img-circle">-->
                <!--                            <div class="ml-2">-->
                ...
                <!--                        </div>-->
                <!--                        <a href="javascript:void(0)" class="d-flex align-items-center"><img-->
                <!--                                src="../public/admin/plugins/images/users/ritesh.jpg" alt="user-img" class="img-circle">-->
                <!--                            <div class="ml-2">-->
                ...
                <!--                        </div>-->
                <!--                        <a href="javascript:void(0)" class="d-flex align-items-center"><img-->
                <!--                                src="../public/admin/plugins/images/users/arijit.jpg" alt="user-img" class="img-circle">-->
                <!--                            <div class="ml-2">-->
                ...
                <!--                        </div>-->
                <!--                        <a href="javascript:void(0)" class="d-flex align-items-center"><img-->
                <!--                                src="../public/admin/plugins/images/users/govinda.jpg" alt="user-img"-->
                <!--                                class="img-circle">-->
                <!--                            <div class="ml-2">-->
                ...
                <!--                        </div>-->
                <!--                        <a href="javascript:void(0)" class="d-flex align-items-center"><img-->
                <!--                                src="../public/admin/plugins/images/users/hritik.jpg" alt="user-img" class="img-circle">-->
                <!--                            <div class="ml-2">-->
    ...
    <script src="../public/admin/plugins/bower_components/popper.js/dist/umd/popper.min.js"></script>
    <script src="../public/admin/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="../public/admin/js/app-style-switcher.js"></script>
    <script src="../public/admin/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!--Wave Effects -->
    ...
    <!--chartis chart-->
    <script src="../public/admin/plugins/bower_components/chartist/dist/chartist.min.js"></script>
    <script src="../public/admin/plugins/bower_components/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <script src="../public/admin/js/pages/dashboards/dashboard1.js"></script>
</body>
